Pego de Rocketseat **[Desafio06](https://github.com/Rocketseat/bootcamp-gostack-desafios/blob/master/desafio-database-upload/README.md)**
...
- Criar database no postgres com as credenciais iguais as do arquivo `ormconfig.json`
- Para rodar os testes, criar também o banco de dados com nome`gostack_desafio06_tests`
- Rode o comando `yarn typeorm migration:run` para executar as migrations e criar as tabelas no banco de dados
